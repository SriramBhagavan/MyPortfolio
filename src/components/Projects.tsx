  ...
  const projects = [
    {
      ...
      tech: ["MERN Stack", "OpenAI API", "Redux", "Tailwind CSS", "Render & Vercel Deployment"],
      demoUrl: "https://ai-resume-builder-ten-nu.vercel.app/",
      youtubeUrl: "https://youtu.be/7YrOOxsHUsg",
      featured: true,
    },
    {
